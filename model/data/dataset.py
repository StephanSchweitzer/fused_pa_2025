...
class ValenceArousalDataset(Dataset):
    def __init__(self, config: Dict):
        ...
        for item in all_metadata:
            ...
            try:
                ...
                # Clamp values to [0, 1] ranges instead of rejecting
    ...
    def _create_cross_emotional_mappings(self):
        ...
        # Fix the pickle issue: use regular dict instead of lambda defaultdict
    ...
    def __getitem__(self, idx):
        """Return a cross-emotional pair for training."""
